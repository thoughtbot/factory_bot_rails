...
You may need to configure your test suite to include factory_girl methods see [configuration](https://github.com/thoughtbot/factory_girl/blob/master/GETTING_STARTED.md#configure-your-test-suite).
## Contributing
